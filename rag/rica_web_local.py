...
if __name__ == "__main__":
    ...
    # Caution terminal run pip install pyngrok
    #and ngrok config add-authtoken YOUR_TOKEN_HERE
    #add/chat in index.html
    #if you use ngrok http 7861
    # Open a public tunnel to your FastAPI port
    public_url = ngrok.connect(7861).public_url
    print("🚀 Public URL for RICA chatbot:", public_url)
    print("💡 Use this URL in your index.html instead of localhost")
