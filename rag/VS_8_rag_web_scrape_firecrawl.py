...
persistent_directory = os.path.join(db_dir, "chroma_crawl_RC_db")
...
def create_vector_store():
    ...
    loader = FireCrawlLoader(
        api_key=api_key, url="https://www.richmondcollege.co.uk", mode="crawl",params={"limit": 5, "depth": 3})
    docs = loader.load()
...
query = "what are global partners of the RC?"
